...
@dataclass
class StepSFTConfig(SFTConfig):
    data_path: str = field(default="xinlai/math-step-sft-10K")
    prompt: str = field(default="alpaca")

def main():    
    parser = H4ArgumentParser((ModelArguments, DataArguments, StepSFTConfig))
